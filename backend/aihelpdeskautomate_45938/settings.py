"""
Django settings for aihelpdeskautomate_45938 project.
...
ROOT_URLCONF = 'aihelpdeskautomate_45938.urls'
...
WSGI_APPLICATION = 'aihelpdeskautomate_45938.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "aihelpdeskautomate_45938 API",
    "DESCRIPTION": "API documentation for aihelpdeskautomate_45938 App",
    "VERSION": "v1",
}
